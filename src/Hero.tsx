        ...
        <section className="h-screen relative bg-[url('./assets/profile_photo.svg')] bg-no-repeat bg-slide-in">
            ...
            <div className="content-container">
                <div className="relative z-1 pt-40 space-y-4">
                    ...
                    <div className="mx-auto text-center text-3xl border w-60 p-3 rounded-full cursor-pointer jump-up-down" style={{animationDelay: "500ms"}}><a href="#projects">View projects</a></div>
                </div>
            </div>
        </section>
    );
